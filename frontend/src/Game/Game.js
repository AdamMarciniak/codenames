...
export const JoinGame = ({ match: { params } }) => {
  ...
  const [joinGame, joiningGame] = useApiCall('joinGame', { name, gameCode: code.toUpperCase(), avatar: avatar }, setError);
  ...
  return (
    <div className="form-wrap">
      ...
      <div className="form">
        ...
        <button disabled={joiningGame || hasJoinedGame} onClick={handleSubmit}>Join Game</button>
      </div>
    </div>
  )
}
...
export const CreateGame = () => {
  ...
  const [name, setName] = useState('');
  const [error, setError] = useState(null);
  const [createGame, creatingGame] = useApiCall('createGame', { name, avatar }, setError);
  ...
  return (
    ...
    <Modal setShowModal={setShowModal} showModal={showModal} text={modalText}/>
      <div className="form">
        ...
        <p>Draw Yourself!</p>
        <DrawBox setAvatar={setAvatar}/>
        <button onClick={handleSubmit} disabled={creatingGame || hasCreatedGame}>Create Game</button>
      </div>
    </div>
  )
}
